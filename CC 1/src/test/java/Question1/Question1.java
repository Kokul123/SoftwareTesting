...
public class Question1 {
	...
	public static void main(String[] args) {
		...
		if(check_cart.equals("Continue Shopping")) {
			System.out.println("Hey ! cart is opened smoothly ");
		...
		if(checkout.equals("Checkout: Your Information")) {
			System.out.println("Your information displayed");
		...
		driver.findElement(By.xpath("//*[@id=\"first-name\"]")).sendKeys("KOKUL KANNA");
		driver.findElement(By.xpath("//*[@id=\"last-name\"]")).sendKeys("S");
		driver.findElement(By.xpath("//*[@id=\"postal-code\"]")).sendKeys("620021");
